...
**Week 6 — ShadowVenue + ops processes.** Build `ShadowVenue` (Doc 3 §4's SIMULATION mode) and the Watchdog + Control CLI processes (Doc 4 §8-9). Begin the Phase 2 shadow run. *Effort: ~15h.*
